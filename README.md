...
python -m sglang.launch_server --model-path meta-llama/Llama-3.1-405B-Instruct-FP8 --port 30000 --tp-size 8
python -m sglang.launch_server --model-path Team-ACE/ToolACE-8B --port 30000 
python -m sglang.launch_server --model-path MadeAgents/Hammer-7b --port 30000 
python -m sglang.launch_server --model-path Salesforce/xLAM-7b-r --port 30020
python -m sglang.launch_server --model-path Akul/ldst --port 30010 
python -m sglang.launch_server --model-path Brendan/nc-latent-tod-step-2-final --port 30020
python -m sglang.launch_server --model-path xingyaoww/CodeActAgent-Mistral-7b-v0.1 --port 30010  
python -m sglang.launch_server --model-path Zekunli/FncTOD-Llama-13b --port 30000 

python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merged/experiment0-suvodip-fc-epoch2/ --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merged/experiment1-emrecan-fc-epoch3/ --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merged/experiment2-emrecan-suvodip-fc/ --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merged/experiment3-emrecan-suvodip-masking-fc/ --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-experiment4/ --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/qwen2.5-7b-experiment4-new/ --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-experiment6 --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-experiment7 --port 30020 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Hammer2.0-7b-experiment8 --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/ToolACE-8B-experiment8 --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-experiment9 --port 30000 
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-experiment10 --port 30000

python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-ablation2-2epoch --port 30000
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-ablation3-2epoch --port 30010
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-ablation3_1 --port 30000
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-8B-Instruct-ablation3_2 --port 30010


python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-70B-Instruct-experiment7 --port 30000 --tp-size 8
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-70B-Instruct-experiment7-epoch1 --port 30000 --tp-size 8
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.1-70B-Instruct-experiment7-q4-epoch1 --port 30000 --tp-size 8
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.3-70B-Instruct-experiment7-q4 --port 30000 --tp-size 8
python -m sglang.launch_server --model-path meta-llama/Llama-3.3-70B-Instruct --port 30000 --tp-size 8
python -m sglang.launch_server --model-path /shared/storage-01/users/acikgoz2/merge/Llama-3.3-70B-Instruct-experiment7-ds3 --port 30000 --tp-size 8 

python -m sglang.launch_server --model-path uiuc-convai/CALM-70B --port 30000 --tp-size 8
